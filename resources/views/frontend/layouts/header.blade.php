<section class="header">
    <div class="container">
        <nav class="navbar navbar-expand-md navbar-light">
            <a href="{{ URL::to('/') }}" class="navbar-brand"><img src="{{ URL::to('/') }}/upload/logo_images/{{ $logo->image }}" style="height: 50px;"></a>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav popular">
                    ...
                    <a href="{{ route('news.events') }}" class="nav-item nav-link">News and Event</a>

        ...
        <div class="row">
          ...
          <section class="col-12 connectedSortable">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('news_event.store') }}" method="POST" id="myForm" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <img id="news_image_src" src="" style="border: 1px solid #000; width:100px; height:100px" alt="">
                            </div>

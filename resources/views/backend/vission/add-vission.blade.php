        ...
        <div class="row">
          ...
          <section class="col-12 connectedSortable">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('vission.store') }}" method="POST" id="myForm" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="title">Title</label>
                                <textarea type="text" name="title" class="form-control" rows="6" ></textarea>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                <img id="vission_image_src" src="" style="border: 1px solid #000; width:100px; height:100px" alt="">
                            </div>
